...
const IC: Record<string, ReactNode> = {
  link: (
    <>
      <path d="M10.5 13.5a4 4 0 0 0 5.66 0l3-3a4 4 0 0 0-5.66-5.66l-1.2 1.2" />
      <path d="M13.5 10.5a4 4 0 0 0-5.66 0l-3 3a4 4 0 0 0 5.66 5.66l1.2-1.2" />
    </>
  ),
  expand: (
    <>
...
function HexNode({ k, size = 68 }: { k: string; size?: number }) {
  ...
  return (
    <span className="hexo" style={{ width: size, height: h }}>
      ...
      >
        <polygon
          points="17,2.5 47,2.5 61.5,28 47,53.5 17,53.5 2.5,28"
          fill="rgba(8,20,60,0.88)"
          stroke="#5B8CFF"
          strokeWidth="2"
          strokeLinejoin="round"
        />
...
const HERO_NODES = [
  ...
  { k: 'expand', t: 'Extend', d: 'Build and extend clean core', x: '90%', y: '24%', lp: 'right' },
  {
    k: 'code',
    t: 'Build',
    d: 'Develop apps and automate processes',
    x: '90%',
    y: '62%',
    lp: 'right',
  },
  {
    k: 'chart',
    t: 'Understand',
    d: 'Unify data and turn into insights',
    x: '58%',
    y: '92%',
    lp: 'right',
  },
  {
    k: 'sparkle',
    t: 'Intelligent',
    d: 'Apply AI and intelligent capabilities',
    x: '10%',
    y: '42%',
    lp: 'below',
  },
...
const ENABLES = [
  {
    ...
    k: 'link',
    t: 'Connect',
    s: 'Integration & API Management',
    d: 'Connect SAP and non-SAP applications through scalable, reusable integration.',
  },
  {
    n: '02',
    k: 'cube',
    t: 'Extend',
    s: 'Clean Core Extensions',
    d: 'Create new capabilities without unnecessarily modifying the SAP core.',
  },
  {
    n: '03',
    k: 'code',
    t: 'Build',
    s: 'Application Development & Automation',
    d: 'Turn business requirements into applications and automated workflows faster.',
  },
  {
    n: '04',
    k: 'chart',
    t: 'Understand',
    s: 'Data & Analytics',
    d: 'Unify enterprise data and turn it into trusted insights with advanced analytics and modeling.',
  },
  {
    n: '05',
    k: 'sparkle',
    t: 'Intelligent',
    s: 'AI & Intelligent Applications',
    d: 'Embed AI across applications, workflows and experiences to drive smarter outcomes.',
  },
  {
    n: '06',
    k: 'shield',
    t: 'Govern',
    s: 'Strategy & Platform Foundation',
    d: 'Build the right architecture, governance, security and operating model to scale BTP with confidence.',
  },
];
const STRATEGY = [
  {
    k: 'roadmap',
    t: 'BTP Strategy & Roadmap',
    d: 'Define the role BTP will play across your SAP and enterprise technology landscape.',
  },
  {
    k: 'architect',
    t: 'Architecture & Landscape Design',
    d: 'Design the appropriate BTP account structure, services, environments and integration architecture.',
  },
  {
    k: 'shieldCheck',
    t: 'Governance & Operating Model',
    d: 'Establish standards for security, development, integration, extensions and platform operations.',
  },
  {
    k: 'lock',
    t: 'Security & Identity',
    d: 'Design identity, access and security controls across the BTP landscape.',
  },
  {
    k: 'lock',
    t: 'Clean Core Strategy',
    d: 'Determine what belongs in the SAP core, what should be extended and where BTP can provide the right innovation layer.',
  },
  {
    k: 'list',
    t: 'Use-case Prioritisation',
    d: 'Identify and prioritise BTP opportunities based on business value, feasibility and strategic importance.',
  },
];
const APPROACH = [
  {
    ...
    k: 'search',
    t: 'Assess',
    d: 'Understand your SAP landscape, integrations, extensions, data and innovation priorities.',
    c: BLUE,
  },
  {
    n: '02',
    k: 'architect',
    t: 'Architect',
    d: 'Define the target BTP architecture, Clean Core principles, security, governance and operating model.',
    c: GREEN,
  },
  {
    n: '03',
    k: 'link',
    t: 'Connect',
    d: 'Integrate SAP, cloud, legacy and third-party applications through reusable APIs and events.',
    c: BLUE,
  },
  {
    n: '04',
    k: 'extendBox',
    t: 'Extend',
    d: 'Build side-by-side extensions and apps without unnecessarily modifying the SAP core.',
    c: GREEN,
  },
  {
    n: '05',
    k: 'sparkle',
    t: 'Innovate',
    d: 'Introduce automation, data-driven experiences, SAP Business AI and enterprise AI use cases.',
    c: BLUE,
  },
  {
    n: '06',
    k: 'chart',
    t: 'Scale',
    d: 'Industrialise successful capabilities through reusable services, governance, monitoring and continuous improvement.',
    c: GREEN,
  },
];
const PILLARS = [
  {
    k: 'shieldCheck',
    t: 'Clean Core Aligned',
    d: 'Protect the integrity, maintainability and upgradeability of the SAP core.',
  },
  {
    k: 'link',
    t: 'SAP + Non-SAP Connectivity',
    d: 'Connect SAP with the broader enterprise technology ecosystem.',
  },
  {
    k: 'sparkle',
    t: 'AI-First Innovation',
    d: 'Identify AI opportunities across applications, integrations, data and workflows from day one.',
  },
  {
    k: 'code',
    t: 'Low-Code to Pro-Code',
    d: 'Use the right development approach for each business requirement.',
  },
  {
    k: 'users',
    t: 'Business-Led. Technology-Enabled.',
    d: 'Start with the business problem and determine where value can be created.',
  },
  {
    k: 'chart',
    t: 'Built to Evolve',
    d: 'Create an architecture that adapts to new SAP capabilities, AI services and emerging models.',
  },
];
...
export default function BtpPage() {
  ...
  const outlineBtn = (c: string): CSSProperties => ({
    display: 'inline-flex',
    alignItems: 'center',
    gap: '0.5rem',
    height: '44px',
  ...
  return (
    <>
      ...
      <section
        style={{
          position: 'relative',
          background: 'linear-gradient(120deg,#050E2B 0%,#0A1B4D 60%,#0A2A7A 100%)',
          overflow: 'hidden',
        }}
      >
        <div
        ...
        >
          <Reveal>
            ...
            >
              Connect. Extend.
              <br />
              Innovate with <span style={{ color: ORANGE }}>AI.</span>
            </h1>
            <p
              style={{
                fontSize: '0.9375rem',
            ...
            >
              Turn your SAP core into an innovation platform. Connect applications and data, extend
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              ...
              <Link href="/services/applications" style={outlineBtn('rgba(255,255,255,0.4)')}>
                Explore Your BTP Transformation <Arrow color="#fff" />
              </Link>
            </div>
          </Reveal>
                ...
                {HERO_NODES.map((n) => (
                  <div
                    ...
                    style={{
                      left: n.x,
                      top: n.y,
                      flexDirection: n.lp === 'below' ? 'column' : 'row',
                    }}
                  >
                    <HexNode k={n.k} />
      ...
      {/* ═══ WHAT BTP ENABLES ═══ */}
      <section
        style={{ background: t.bg2, padding: 'clamp(4.5rem,8vw,7rem) clamp(1.25rem,5vw,3.5rem)' }}
      >
        <div style={{ maxWidth: 'var(--layout-content-wide)', margin: '0 auto' }}>
          <Reveal>
            ...
            >
              One Platform. Multiple Paths to Innovation.
            </h2>
          </Reveal>
          <div
            style={{
            ...
            {ENABLES.map((c, i) => (
              <Reveal key={c.n} delay={i * 70}>
                ...
                >
                  ...
                  <h3 style={{ fontSize: '1rem', fontWeight: 800, color: t.heading, margin: 0 }}>
                    {c.t}
                  </h3>
                  <p
                    style={{ fontSize: '0.8125rem', fontWeight: 700, color: t.heading, margin: 0 }}
                  >
                    {c.s}
                  </p>
                  <p
      ...
      <section
        style={{ padding: 'clamp(2rem,4vw,3.5rem) clamp(1.25rem,5vw,3.5rem)', background: t.bg2 }}
      >
        <div style={{ maxWidth: 'var(--layout-content-wide)', margin: '0 auto' }}>
          <Reveal>
            <div
              style={{
                background: 'linear-gradient(120deg,#050E2B,#0A1B4D)',
            ...
            >
              <div>
                ...
                >
                  The right BTP architecture begins with business priorities—not technology for its
                  own sake.
                </p>
                <p
                  style={{
      ...
      >
        ...
        >
          <Reveal>
            ...
            >
              Simplify the Core. Connect the Enterprise. Accelerate Innovation.
            </h2>
          </Reveal>
          <div
            ...
            {APPROACH.map((s, i) => (
              <Reveal key={s.n} delay={i * 70} style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  ...
                  <h3
                    style={{ fontSize: '0.875rem', fontWeight: 800, color: t.heading, margin: 0 }}
                  >
                    {s.t}
                  </h3>
          ...
          <div style={{ marginTop: '2.5rem' }}>
            <Link href="/services/applications" style={outlineBtn(BLUE)}>
              See Our Approach in Action <Arrow color={BLUE} />
            </Link>
          </div>
        </div>
      </section>
      ...
      {/* ═══ PILLARS (dark band) ═══ */}
      <section
        style={{ padding: '0 clamp(1.25rem,5vw,3.5rem) clamp(3rem,6vw,4.5rem)', background: t.bg2 }}
      >
        <div style={{ maxWidth: 'var(--layout-content-wide)', margin: '0 auto' }}>
          <Reveal>
            <div
      ...
      <section
        style={{ padding: '0 clamp(1.25rem,5vw,3.5rem) clamp(4rem,7vw,6rem)', background: t.bg2 }}
      >
        <div style={{ maxWidth: 'var(--layout-content-wide)', margin: '0 auto' }}>
          <Reveal>
            <div
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  inset: 0,
                  background: isDark
                    ? 'linear-gradient(90deg,rgba(3,13,34,0.94) 0%,rgba(3,13,34,0.82) 45%,rgba(3,13,34,0.35) 100%)'
                    : 'linear-gradient(90deg,rgba(244,246,248,0.96) 0%,rgba(244,246,248,0.85) 45%,rgba(244,246,248,0.25) 100%)',
                }}
              />
              <div
                style={{
              ...
              >
                <div style={{ maxWidth: '38ch' }}>
                  ...
                  >
                    Ready to Turn Your SAP Core into an Innovation Platform?
                  </h2>
                  <p style={{ fontSize: '0.875rem', lineHeight: 1.7, color: t.body, margin: 0 }}>
                    Build a connected, intelligent and extensible enterprise foundation with SAP
