...
const IC: Record<string, ReactNode> = {
  ...
  people: (
    <>
      ...
      <path d="M2.5 19c.6-3.2 2.9-5.5 5.5-5.5S13.4 15.8 14 19" />
      <circle cx="16.5" cy="8.5" r="2.5" />
      <path d="M15.5 13.7c2.3.3 4 2.2 4.5 5.3" />
    </>
  ),
  chartUp: (
    <>
  ...
  badge: (
    <>
      ...
      <path d="M12 8l1.2 2.4 2.6.4-1.9 1.8.4 2.6-2.2-1.2-2.2 1.2.4-2.6-1.9-1.8 2.6-.4L12 8z" />
    </>
  ),
  user: (
    <>
      <circle cx="12" cy="7" r="3.5" />
      <path d="M5 19.5c.8-3.6 3.6-6 7-6s6.2 2.4 7 6" />
    </>
  ),
  target: (
    <>
  ...
  reward: (
    <>
      ...
      <path d="M12 8v13M3 12v9h18v-9" />
      <path d="M12 8c-1.5-3-6-3-6-.5S10 8 12 8zm0 0c1.5-3 6-3 6-.5S14 8 12 8z" />
    </>
  ),
  transition: (
    <>
  ...
  brain: (
    <>
      <path d="M9.5 3A3.5 3.5 0 0 0 6 6.5c-2 .5-3 2-3 4 0 1.6.8 3 2 3.7-.1 2.3 1.6 4.3 4 4.3.6 0 1.2-.1 1.7-.4" />
      <path d="M14.5 3A3.5 3.5 0 0 1 18 6.5c2 .5 3 2 3 4 0 1.6-.8 3-2 3.7.1 2.3-1.6 4.3-4 4.3-.6 0-1.2-.1-1.7-.4" />
      <path d="M12 3v17" />
    </>
  ),
  cap: (
  ...
  shuffle: (
    <>
      <path d="M3 6h3.5c5 0 6.5 8 11.5 8H21" />
      <path d="M3 14h3.5c1.6 0 2.8-.8 3.8-2M21 6h-1.5c-1.6 0-2.8.8-3.8 2" />
      <path d="M18.5 3.5L21 6l-2.5 2.5M18.5 13.5L21 16l-2.5 2.5" />
    </>
  ),
  gear: (
    <>
  ...
  puzzle: (
    <path d="M10 3.5a2 2 0 0 1 4 0V5h4a1 1 0 0 1 1 1v4h1.5a2 2 0 0 1 0 4H15v4a1 1 0 0 1-1 1h-4v-1.5a2 2 0 0 0-4 0V20H6a1 1 0 0 1-1-1v-4H3.5a2 2 0 0 1 0-4H5V6a1 1 0 0 1 1-1h4V3.5z" />
  ),
  clock: (
    <>
  ...
  network: (
    <>
      ...
      <path d="M7.5 7.8l3 7M16.5 7.8l-3 7M8.5 6h7" />
    </>
  ),
  arrowUp: (
    <>
  ...
  heart: (
    <path d="M12 20.5S4 15 4 9.5C4 6.5 6.5 4 9.5 4c1 0 2 .4 2.5 1 .5-.6 1.5-1 2.5-1C17 4 19.5 6.5 19.5 9.5c0 5.5-8 11-8 11z" />
  ),
  check: (
    <>
      <circle cx="12" cy="12" r="8.5" />
    ...
    <>
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'linear-gradient(120deg, rgba(5,14,43,0.88) 0%, rgba(10,27,77,0.72) 55%, rgba(10,42,122,0.45) 100%)',
        }}
      />
    </>
  );
...
const AGENDA = [
  {
    ...
    items: [
      ...
      'Career Sites & Candidate Experience',
      'AI-Assisted Talent Discovery & Matching',
      'Interview & Hiring Workflows',
      'Offer Management',
  ...
  },
  {
    ...
    items: [
      ...
      'Preboarding & Employee Documentation',
      'Automated Tasks & Approvals',
      'Personalised Onboarding Experiences',
      'Role-Based Learning & Enablement',
    ],
  },
  {
    n: '03',
...
const AI_ROW1 = [
  {
    k: 'search',
    t: 'AI-Assisted Recruiting',
    d: 'Improve candidate discovery, matching and hiring decisions.',
  },
  {
    k: 'brain',
    t: 'Skills Intelligence',
    d: 'Identify skills, gaps and development opportunities across the workforce.',
  },
  {
    k: 'cap',
    t: 'Personalised Learning',
    d: 'Recommend relevant learning and career development pathways.',
  },
  {
    k: 'people',
    t: 'Talent Intelligence',
    d: 'Support career mobility, succession and workforce planning.',
  },
];
const AI_ROW2 = [
  ...
  {
    k: 'chartUp',
    t: 'Predictive Workforce Insights',
    d: 'Identify workforce trends and support more informed HR decisions.',
  },
  {
    k: 'sparkle',
    t: 'Generative AI for HR',
    d: 'Assist with content creation, summaries, communications and other high-volume HR activities.',
  },
];
const APPROACH = [
  {
    ...
    k: 'search',
    t: 'Discover',
    d: 'Understand your workforce strategy, HR landscape, employee journeys and transformation priorities.',
  },
  {
    n: '02',
    k: 'layers',
    t: 'Adopt',
    d: 'Leverage preconfigured Hire-to-Retire processes based on leading practices to reduce unnecessary design effort.',
  },
  {
    n: '03',
    k: 'shuffle',
    t: 'Transform',
    d: 'Challenge existing processes and identify where standardisation, automation and AI can create greater value.',
  },
  {
    n: '04',
    k: 'gear',
    t: 'Implement',
    d: 'Configure and deploy SAP SuccessFactors using an accelerated, outcome-led delivery approach.',
  },
  {
    n: '05',
    k: 'sparkle',
    t: 'Innovate',
    d: 'Embed AI and intelligent automation across selected HR processes.',
  },
  {
    n: '06',
    k: 'chartUp',
    t: 'Evolve',
    d: 'Continuously optimise employee experience, adoption, analytics and AI opportunities after go-live.',
  },
];
const WHY = [
  {
    k: 'puzzle',
    t: 'Preconfigured Hire-to-Retire',
    d: 'Start with ready-to-adopt HR processes and leading practices instead of designing everything from scratch.',
  },
  {
    k: 'clock',
    t: 'Faster Time to Value',
    d: 'Use standardisation, reusable assets and fit-to-standard adoption to accelerate the journey from strategy to deployment.',
  },
  {
    k: 'chip',
    t: 'AI-First by Design',
    d: 'Identify AI opportunities as part of the transformation—not as a separate initiative after implementation.',
  },
  {
    k: 'people',
    t: 'Employee-Centric Experience',
    d: 'Design around the moments that matter for candidates, employees, managers and HR teams.',
  },
  {
    k: 'network',
    t: 'Business + Technology',
    d: 'Connect HR strategy, processes, SAP SuccessFactors, integration, data and AI across the wider enterprise.',
  },
  {
    k: 'arrowUp',
    t: 'Built to Evolve',
    d: 'Create a digital HR foundation that can adapt to changing skills, workforce models, SAP innovations and emerging AI capabilities.',
  },
];
const CHAIN = [
  ...
  { k: 'layers', t: 'Process', d: 'Hire-to-Retire workflows and business processes.' },
  {
    k: 'db',
    t: 'Data',
    d: 'Workforce information, skills, performance and organisational insights.',
  },
...
export default function SuccessFactorsPage() {
  ...
  const outlineBtn = (onDark = false): CSSProperties => ({
    display: 'inline-flex',
    alignItems: 'center',
    gap: '0.5rem',
    height: '44px',
    padding: '0 1.5rem',
    borderRadius: 'var(--radius-sm)',
    border: `1px solid ${onDark ? 'rgba(255,255,255,0.4)' : t.border}`,
    color: onDark ? '#fff' : t.heading,
    fontSize: '0.875rem',
    fontWeight: 600,
    textDecoration: 'none',
  ...
  return (
    <>
      ...
      <section
        style={{
          position: 'relative',
          background: 'linear-gradient(120deg,#050E2B 0%,#0A1B4D 55%,#0A2A7A 100%)',
          overflow: 'hidden',
        }}
      >
        <HeroBackground />
        <div
          style={{
            ...
            margin: '0 auto',
            padding:
              'calc(36px + var(--layout-header-height-desktop) + 40px) clamp(1.25rem,5vw,3.5rem) clamp(4rem,7vw,6rem)',
            display: 'grid',
        ...
        >
          <Reveal>
            ...
            >
              ...
              <span style={{ color: '#fff', fontWeight: 700 }}>SAP SuccessFactors</span>
            </nav>
            <p
              style={{
            ...
            >
              Reimagine
              <br />
              Hire-to-Retire with <span style={{ color: ORANGE }}>AI</span>
            </h1>
            <p
              style={{
                fontSize: '0.9375rem',
            ...
            >
              Human experiences. Intelligent HR. Better outcomes.
            </p>
            <div
              style={{ width: '56px', height: '3px', background: ORANGE, marginBottom: '1.5rem' }}
            />
            <p
              style={{
                fontSize: '0.9375rem',
            ...
            >
              Transform HR from a system of record into an intelligent, connected experience.
            </p>
            <p
              style={{
                fontSize: '0.9375rem',
            ...
            >
              We help organisations modernise the complete Hire-to-Retire journey with SAP
              SuccessFactors—combining leading HR practices, preconfigured processes, automation and
              AI to simplify work for HR teams, managers and employees.
            </p>
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <Link href="/contact/customer-support?intent=expert" style={orangeBtn}>
                Talk to an Expert <Arrow />
              </Link>
              <Link href="/services/applications" style={outlineBtn(true)}>
                Explore Your HR Transformation <Arrow />
              </Link>
            </div>
          </Reveal>
            ...
            >
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 40px rgba(20,88,242,0.35), inset 0 0 30px rgba(20,88,242,0.2)',
                  animation: 'sfSpin 40s linear infinite',
                }}
              />
              <div
                style={{
                  ...
                  aspectRatio: '1/1',
                  borderRadius: '50%',
                  background: 'linear-gradient(160deg,#0A1B4D,#050E2B)',
                  border: '2px solid rgba(60,121,255,0.6)',
                  display: 'flex',
                  flexDirection: 'column',
                  alignItems: 'center',
                  justifyContent: 'center',
                  gap: '0.5rem',
                  boxShadow: '0 0 50px rgba(20,88,242,0.4)',
                }}
              >
                <span
                  style={{
              ...
              {H2R_NODES.map((n, i) => (
                <div
                  ...
                  style={{
                    ...
                    display: 'flex',
                    flexDirection:
                      n.place === 'top' ? 'column' : n.place === 'bottom' ? 'column' : 'row',
                    alignItems: 'center',
                    gap: '0.5rem',
                    animation: `sfFloat 5s ease-in-out ${i * 0.5}s infinite`,
                  }}
                >
                  {n.place === 'left' && (
                    <span
                  ...
                  <span
                    style={{
                      ...
                      justifyContent: 'center',
                      color: '#fff',
                      boxShadow: '0 0 0 5px rgba(20,88,242,0.25)',
                      flexShrink: 0,
                    }}
                  >
                    <Ic k={n.k as string} size={22} color="#fff" />
                  </span>
                  {n.place !== 'left' && n.place !== 'top' && (
                    <span
                      style={{
                        color: '#fff',
                        fontSize: '0.75rem',
      ...
      <section
        style={{ background: t.bg2, padding: 'clamp(4.5rem,8vw,7.5rem) clamp(1.25rem,5vw,3.5rem)' }}
      >
        <div
          style={{ maxWidth: 'var(--layout-content-wide)', margin: '0 auto' }}
          className="sf-agenda"
        >
          <Reveal>
            <p
            ...
            >
              From Hire-to-Retire
              <br />
              to Hire-to-<span style={{ color: ORANGE }}>Inspire</span>.
            </h2>
            <p
              style={{ fontSize: '0.9375rem', lineHeight: 1.8, color: t.body, margin: '0 0 1rem' }}
            >
              Workforce transformation is no longer simply about digitising HR processes.
            </p>
            <p
              style={{ fontSize: '0.9375rem', lineHeight: 1.8, color: t.body, margin: '0 0 1rem' }}
            >
              It is about creating an employee experience that connects people, processes, workforce
              data, skills and business strategy.
            </p>
            <p style={{ fontSize: '0.9375rem', lineHeight: 1.8, color: t.body, margin: 0 }}>
              TRYVION helps organisations move toward a more intelligent HR model—one where
              technology handles complexity and people can focus on performing, growing and creating
              value.
            </p>
          </Reveal>
      ...
      <section
        style={{
          position: 'relative',
          background: 'linear-gradient(120deg,#0A1B4D 0%,#0A2A7A 100%)',
          overflow: 'hidden',
          padding: 'clamp(4.5rem,8vw,7rem) clamp(1.25rem,5vw,3.5rem)',
        }}
      >
        <img
          src={WAVE}
          ...
          <div className="sf-ai-grid">
            <Reveal>
              ...
              >
                From HR Automation
                <br />
                to <span style={{ color: ORANGE }}>Intelligent HR</span>.
              </h2>
              <p
                style={{
                  fontSize: '0.9375rem',
              ...
              >
                AI should not be an initiative added after implementation.
              </p>
              <p
                style={{
                  fontSize: '0.9375rem',
              ...
              >
                TRYVION identifies opportunities to embed AI across the Hire-to-Retire journey from
                the beginning—helping HR teams simplify work, improve decisions and create more
                    ...
                    >
                      <span
                        style={{
                          ...
                          background: 'rgba(20,88,242,0.15)',
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                        }}
          ...
          <Reveal delay={200}>
            <div
              style={{
                ...
                background: 'rgba(20,88,242,0.12)',
                marginTop: '2rem',
              }}
            >
              ...
              >
                Our approach combines SAP Business AI, Joule and automation with carefully selected
                AI use cases while keeping governance, security and responsible AI at the core.
              </p>
            </div>
          </Reveal>
        </div>
      ...
      <section
        style={{ background: t.bg1, padding: 'clamp(4.5rem,8vw,7.5rem) clamp(1.25rem,5vw,3.5rem)' }}
      >
        <div
          style={{ maxWidth: 'var(--layout-content-wide)', margin: '0 auto', textAlign: 'center' }}
        >
          <Reveal>
            <p
              style={{
            ...
            >
              Preconfigured. AI-First. Experience-Led.
            </h2>
          </Reveal>
                ...
                >
                  <span
                    style={{
                      ...
                      color: '#fff',
                      boxShadow:
                        '0 0 0 6px ' + (isDark ? 'rgba(20,88,242,0.15)' : 'rgba(20,88,242,0.12)'),
                      position: 'relative',
                      zIndex: 1,
                    }}
                  >
                  ...
                  <p style={{ fontSize: '0.75rem', lineHeight: 1.6, color: t.body, margin: 0 }}>
                    {s.d}
                  </p>
                </div>
              </Reveal>
          ...
          <Reveal>
            <h2
              style={{
                textAlign: 'center',
                fontFamily: 'var(--family-display)',
                fontSize: 'clamp(1.6rem,2.8vw,2.125rem)',
                fontWeight: 800,
                letterSpacing: 'var(--tracking-h2)',
                color: t.heading,
                margin: '0 0 2.5rem',
        ...
        >
          <div className="sf-found">
            <Reveal>
              ...
              >
                Connect People, Process, Data and Intelligence.
              </h3>
              <p
                style={{ fontSize: '0.875rem', lineHeight: 1.7, color: t.body, margin: '0 0 2rem' }}
              >
                SAP SuccessFactors should not operate as an isolated HR platform.
              </p>
              <div
                style={{
                  display: 'flex',
                    ...
                    >
                      <span
                        style={{
                          ...
                          height: '44px',
                          borderRadius: '50%',
                          border: `1px solid ${isDark ? 'rgba(120,160,255,0.5)' : 'rgba(20,88,242,0.4)'}`,
                          background: t.cardBg,
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                      ...
                      <span style={{ fontSize: '0.6875rem', lineHeight: 1.5, color: t.body }}>
                        {c.d}
                      </span>
                    </div>
                    {i < CHAIN.length - 1 && (
                      <span
                        aria-hidden="true"
                        style={{
                          borderTop: `2px dashed ${isDark ? 'rgba(120,160,255,0.4)' : 'rgba(20,88,242,0.35)'}`,
                          width: '16px',
                          marginTop: '22px',
                          flexShrink: 0,
                        }}
            ...
            <Reveal delay={120}>
              <div className="sf-found-right" style={{ position: 'relative', height: '100%' }}>
                ...
                >
                  From Hire-to-Retire to Hire-to-Inspire
                </p>
                <h3
                  style={{
                    fontFamily: 'var(--family-display)',
                ...
                >
                  Make HR Technology Work for People.
                </h3>
                <p
                  style={{
                    fontSize: '0.875rem',
                ...
                >
                  Technology should handle complexity so your people can focus on what matters most.
                </p>
                <ul
                  style={{
                    listStyle: 'none',
                ...
                <p style={{ fontSize: '0.875rem', lineHeight: 1.7, color: t.body, margin: 0 }}>
                  TRYVION helps organisations transform SAP SuccessFactors into an intelligent HR
                  foundation designed for the future of work.
                </p>
              </div>
            </Reveal>
          </div>
      ...
      <section
        style={{
          background: 'linear-gradient(120deg,#050E2B 0%,#0A1B4D 100%)',
      ...
      >
        ...
        >
          <Reveal>
            ...
            >
              Ready to reimagine your Hire-to-Retire journey?
            </h2>
            <p
              style={{
                fontSize: '0.875rem',
            ...
            >
              Create a more intelligent, connected and human-centred HR experience with SAP
              SuccessFactors.
            </p>
          </Reveal>
          <Reveal delay={120}>
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              ...
              <Link href="/contact/customer-support?intent=consultation" style={outlineBtn(true)}>
                Book a Consultation <Arrow />
              </Link>
              <Link href="/services/applications" style={outlineBtn(true)}>
                Explore TRYVION Applications <Arrow />
              </Link>
            </div>
          </Reveal>
        </div>
