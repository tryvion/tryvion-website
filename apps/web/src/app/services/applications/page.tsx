...
const IMG = {
  ...
  layers:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/1e16e9d83-760c-413c-9cf0-9b4e3e75c860.png',
  service:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/125eb01b2-e05d-4320-86be-ff7354b0abaa.png',
  consumer:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/116b49da0-c506-4529-8bed-ac67f798d71b.png',
  financial:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/1d01814a7-b5bb-4dad-bb68-9031bb140d4b.png',
  publicSvc:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/16c423a3c-78db-4653-ba57-17c43c954230.png',
  discrete:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/184ef1bcf-5f5d-40d2-b521-502ac32e458a.png',
  energy:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/1d8ef1705-9b58-4198-a036-95a2a0b95798.png',
  insight1:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/1fae2de36-06be-43dc-8765-726f1938e13d.png',
  insight2:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/138f176a1-c65a-431f-a8b0-028a18e6a997.png',
  insight3:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/18859172a-8e51-4536-9e93-0ae84666fab8.png',
  careers:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/176a9b55b-693c-4c43-a42e-cdfac99f6305.png',
  earth:
    'https://image.qwenlm.ai/public_source/dd8f5ab0-54d9-4499-96dc-b6afb2fb48db/13da31f13-b074-4808-ab7b-2c89c75d3b09.png',
};
  ...
  return (
    <p
      style={{
        ...
        color: color ?? 'var(--content-accent, #715300)',
        margin: '0 0 1rem',
...
export default function ApplicationsPage() {
  ...
  const goldOutline: CSSProperties = {
    display: 'inline-flex',
    alignItems: 'center',
    gap: '0.5rem',
    height: '44px',
    ...
    <>
      ...
      <section style={{ position: 'relative', background: '#030D22', overflow: 'hidden' }}>
        ...
        <div
          style={{
            ...
            zIndex: 1,
            padding:
              'calc(36px + var(--layout-header-height-desktop) + clamp(3rem,6vw,5rem)) clamp(1.25rem,5vw,3.5rem) clamp(4rem,7vw,6.5rem)',
          }}
        >
          <Reveal>
            <nav
      ...
      <section style={{ ...sectionPad, background: t.bg2 }}>
        ...
        >
          ...
          <Reveal delay={120} style={{ justifySelf: 'center' }}>
            <img
              src={IMG.layers}
              alt="Connected enterprise application layers"
              loading="lazy"
              style={{ width: 'min(100%,460px)', height: 'auto', display: 'block' }}
            />
          </Reveal>
        </div>
      </section>
          ...
          >
            {[
              ...
              <Reveal key={c.n} delay={i * 100}>
                ...
                >
                  <p style={{ fontSize: '0.8125rem', fontWeight: 700, color: t.faint, margin: 0 }}>
                    {c.n} —
                  </p>
                ...
                <Link href={c.href} style={textLink}>
                  {c.cta} <Arrow size={12} />
                </Link>
              </Reveal>
            ))}
        ...
        <div style={wrap}>
          <Reveal>
            ...
            >
              ...
              <h2 style={{ ...h2w, margin: '0 auto 1rem' }}>
                From Core Systems to Connected Enterprise.
              </h2>
              <p
                style={{
                  fontSize: '0.9375rem',
              ...
              >
                Modern enterprise applications should not operate as isolated systems. They should
                work together across finance, operations, people, data and technology—creating a
                connected environment where the organisation can continuously evolve.
              </p>
              <div
                style={{
                  display: 'flex',
              ...
              >
                {[
                  {
                    label: 'Core',
                    desc: 'Run the enterprise.',
                    color: t.gold,
                    icon: 'database-outline',
                  },
                  {
                    label: 'People',
                    desc: 'Enable the workforce.',
                    color: '#8B5CF6',
                    icon: 'account-group-outline',
                  },
                  {
                    label: 'Platform',
                    desc: 'Connect and extend the enterprise.',
                    color: '#22D3EE',
                    icon: 'layers-outline',
                  },
                  {
                    label: 'Intelligence',
                    desc: 'Create better decisions and actions.',
                    color: '#34D399',
                    icon: 'brain',
                  },
                  {
            ...
            {[
              {
                ...
                d: 'Technology decisions grounded in business priorities.',
                icon: 'target',
              },
              {
                t: 'Process Simplification',
                d: 'Reducing unnecessary complexity before introducing new technology.',
                icon: 'tune',
              },
              {
                t: 'Standardisation',
                d: 'Adopting proven processes where they create greater efficiency and consistency.',
                icon: 'clipboard-check-outline',
              },
              {
                t: 'Connected Architecture',
                d: 'Creating meaningful connections across applications, data and enterprise processes.',
                icon: 'network-outline',
              },
              {
                t: 'Continuous Evolution',
                d: 'Building an environment that can adapt as business needs and technology change.',
                icon: 'trend-up',
              },
            ].map((f, i) => (
              <Reveal key={f.t} delay={i * 80}>
                ...
                >
                  ...
                  <h3
                    style={{ fontSize: '0.9375rem', fontWeight: 800, color: t.heading, margin: 0 }}
                  >
                    {f.t}
                  </h3>
                  <p style={{ fontSize: '0.8125rem', lineHeight: 1.65, color: t.muted, margin: 0 }}>
                    {f.d}
                  </p>
                </div>
              </Reveal>
            ...
            {[
              {
                ...
                d: 'Connect technology decisions with the business outcomes they are expected to create.',
      ...
      <section style={{ ...sectionPad, background: t.bg2 }}>
        <div style={wrap}>
          ...
          <div className="ind-grid">
            {[
              {
                t: 'Service Industries',
                items:
                  'Professional Services, Media, Tech, Transportation & Logistics, Engineering, Construction & Operations, Sports & Entertainment, Commercial Real Estate, Travel & Leisure',
                img: IMG.service,
              },
              {
                t: 'Consumer Industries',
                items:
                  'Consumer Products, Retail, Fashion, Wholesale Distribution, Life Sciences, Agribusiness',
                img: IMG.consumer,
              },
              { t: 'Financial Services', items: 'Banking, Insurance', img: IMG.financial },
              {
                t: 'Public Services',
                items: 'Public Sector, Healthcare, Education & Research, Defence & Security',
                img: IMG.publicSvc,
              },
              {
                t: 'Discrete Industries',
                items: 'Industrial Manufacturing, High Tech, Automotive, Aerospace & Defence',
                img: IMG.discrete,
              },
              {
                t: 'Energy & Natural Resources',
                items: 'Utilities, Mill Products, Mining, Chemicals, Oil & Gas & Energy',
                img: IMG.energy,
              },
            ].map((ind, i) => (
          ...
          <div style={{ marginTop: '2.5rem', textAlign: 'center' }}>
            <Link href="/industries" style={textLink}>
              Explore Industries <Arrow size={12} />
            </Link>
          </div>
        </div>
      </section>
        ...
        >
          <div style={{ padding: 'clamp(3.5rem,6vw,5.5rem) clamp(1.25rem,5vw,3.5rem)' }}>
            <Reveal>
              ...
              <h2 style={{ ...h2w, margin: '0 0 1.5rem' }}>
                Build What
                <br />
                Comes Next.
              </h2>
              ...
              >
                Transformation needs people who are willing to learn, build and evolve.
              </p>
              <p
                style={{
                  fontSize: '0.875rem',
              ...
              >
                At TRYVION, you can work at the intersection of enterprise technology, AI, learning
                and talent while helping shape what comes next.
              </p>
              <Link href="/careers" style={goldBtn}>
                Life at TRYVION <Arrow />
              </Link>
            </Reveal>
          </div>
      ...
      <section
        style={{
          ...
          background: '#030D22',
          overflow: 'hidden',
          padding: 'clamp(4rem,7vw,6.5rem) clamp(1.25rem,5vw,3.5rem)',
        }}
      >
        <img
          src={IMG.earth}
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(90deg, rgba(3,13,34,0.95) 0%, rgba(3,13,34,0.75) 50%, rgba(3,13,34,0.25) 100%)',
          }}
        />
        <div
          style={{
