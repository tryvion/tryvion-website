...
function Icon({ name, color, size = 30 }: { name: IconName; color: string; size?: number }) {
  ...
  return (
    ...
    >
      {name === 'core' && (
        <>
          <path d="M12 2.6 20 7.1v9.8l-8 4.5-8-4.5V7.1l8-4.5Z" {...fill} />
          <path d="M12 2.6 20 7.1l-8 4.5-8-4.5l8-4.5ZM12 11.6v9.8M20 7.1v9.8M4 7.1v9.8" />
        </>
      )}
      {name === 'connected' && (
        <>
          <circle cx="8" cy="7" r="2.7" {...fill} />
          <circle cx="16.2" cy="8" r="2.2" {...fill} />
          <path d="M8 4.3a2.7 2.7 0 1 1 0 5.4 2.7 2.7 0 0 1 0-5.4ZM3.2 17.5c.6-3.2 2.5-5 4.8-5s4.2 1.8 4.8 5M16.2 5.8a2.2 2.2 0 1 1 0 4.4 2.2 2.2 0 0 1 0-4.4ZM13.6 12.9c2.6.2 4.5 1.9 5.1 4.6M10.5 15.5h5" />
        </>
      )}
      {name === 'intelligent' && (
        <>
          <path d="M7.5 16.5v-4M12 16.5V8M16.5 16.5v-6" />
          <path d="M3.5 3.5v17h17" />
          <path d="M7 8.5 10.5 6l2.5 2 4.5-4" {...fill} stroke={color} />
      ...
      {name === 'future' && (
        <>
          <path
            d="M6.7 18.5a4.2 4.2 0 0 1-.5-8.4 5.7 5.7 0 0 1 11.1-.5 3.9 3.9 0 0 1 .5 7.7"
            {...fill}
          />
          <path d="M6.7 18.5h10.6M12 15.5v-5M9.8 12.7l2.2-2.2 2.2 2.2" />
        </>
      )}
      {name === 'search' && (
        <>
          <circle cx="10.5" cy="10.5" r="6.2" {...fill} />
      ...
      {name === 'eye' && (
        <>
          <path d="M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12Z" {...fill} />
      ...
      {name === 'bolt' && (
        <>
          <path d="M13 2.5 4.5 13.5h6L10 21.5 19.5 10.5h-6L13 2.5Z" {...fill} />
          <path d="M13 2.5 4.5 13.5h6L10 21.5 19.5 10.5h-6L13 2.5Z" />
        </>
      )}
      {name === 'adopt' && (
        <>
          <circle cx="9.5" cy="6.8" r="3" {...fill} />
          <path d="M9.5 3.8a3 3 0 1 1 0 6 3 3 0 0 1 0-6ZM3.5 18.5c.6-3.6 3-5.6 6-5.6 1.2 0 2.3.3 3.2.9" />
          <path d="m14.2 16.6 2.2 2.2 4.3-4.9" />
        </>
      )}
      {name === 'evolve' && (
        <>
          <path d="M3.5 17.5 9 12l3.5 3.5 7-7.5" {...fill} stroke={color} />
          <path d="M3.5 17.5 9 12l3.5 3.5 7-7.5M15.5 8H19.5v4M3.5 21h17" />
        </>
      )}
      {name === 'building' && (
        <>
          <path d="M5.5 21.5V6.8l6-3.3v18" {...fill} />
          <path d="M5.5 21.5V6.8l6-3.3v18M11.5 9.5h6.5v12M3.5 21.5h17M8.5 9h.01M8.5 12.5h.01M8.5 16h.01M14.8 13h.01M14.8 16.5h.01" />
        </>
      )}
      {name === 'conversion' && (
        <>
          <path d="M4.5 12a7.5 7.5 0 0 1 12.9-5.2L20 9.3M20 4.8v4.5h-4.5" />
          <path d="M19.5 12a7.5 7.5 0 0 1-12.9 5.2L4 14.7M4 19.2v-4.5h4.5" />
        </>
      )}
      {name === 'selective' && (
        <>
          <path d="M4 7.5h8.5M17.5 7.5H20M4 16.5h2.5M11.5 16.5H20" />
          <circle cx="15" cy="7.5" r="2.4" {...fill} />
          <circle cx="9" cy="16.5" r="2.4" {...fill} />
      ...
      {name === 'biztech' && (
        <>
          <circle cx="9.5" cy="7" r="3" {...fill} />
          <path d="M9.5 4a3 3 0 1 1 0 6 3 3 0 0 1 0-6ZM3.5 18.5c.6-3.6 3-5.6 6-5.6s5.4 2 6 5.6" />
          <circle cx="17.5" cy="7.5" r="1.9" {...fill} />
          <path d="M17.5 4.2v1.4M17.5 9.4v1.4M14.2 7.5h1.4M19.4 7.5h1.4" />
        </>
      )}
      {name === 'standard' && (
        <>
          <path
            d="M12 2.8l7.5 3v5.4c0 4.8-3.2 8.7-7.5 10-4.3-1.3-7.5-5.2-7.5-10V5.8l7.5-3Z"
            {...fill}
          />
          <path d="M12 2.8l7.5 3v5.4c0 4.8-3.2 8.7-7.5 10-4.3-1.3-7.5-5.2-7.5-10V5.8l7.5-3Z" />
          <path d="m8.7 11.9 2.3 2.3 4.4-5" />
        </>
      )}
      {name === 'cleancore' && (
        <>
          <path d="M12 3.2 20.5 7.7 12 12.2 3.5 7.7 12 3.2Z" {...fill} />
          <path d="M12 3.2 20.5 7.7 12 12.2 3.5 7.7 12 3.2ZM4.5 12l7.5 4 7.5-4M4.5 16.2l7.5 4 7.5-4" />
        </>
      )}
      {name === 'link' && (
        <>
          <path
            d="M10.6 13.4a4.1 4.1 0 0 0 6.1.4l2.2-2.2a4.1 4.1 0 0 0-5.8-5.8l-1.2 1.2"
            {...fill}
            stroke={color}
          />
          <path d="M10.6 13.4a4.1 4.1 0 0 0 6.1.4l2.2-2.2a4.1 4.1 0 0 0-5.8-5.8l-1.2 1.2M13.4 10.6a4.1 4.1 0 0 0-6.1-.4l-2.2 2.2a4.1 4.1 0 0 0 5.8 5.8l1.2-1.2" />
        </>
      )}
      {name === 'loop' && (
        <>
          <path d="M12 4a8 8 0 1 1-7.4 5" />
          <path d="M4 4.5V9h4.5M12 8.5V12l2.5 2.5" />
        </>
      )}
    </svg>
  );
...
function Reveal({
  ...
  return (
    <div
      ref={ref}
      className={`${className} ${show ? 'rv-in' : ''}`}
      style={{
        ...style,
        opacity: show ? 1 : 0,
        transform: show ? 'none' : 'translateY(22px)',
        transition: `opacity .7s cubic-bezier(.2,0,0,1) ${delay}ms, transform .7s cubic-bezier(.2,0,0,1) ${delay}ms`,
      }}
    >
      {children}
    </div>
  ...
  const AGENDA = [
    {
      ...
      color: BLUE,
      t: 'Modern Enterprise Core',
      d: 'Unify and simplify your business processes on a modern, intelligent ERP foundation.',
    },
    {
      icon: 'connected' as IconName,
      color: ORANGE,
      t: 'Connected Enterprise',
      d: 'Bring finance, operations, supply chain and customer experience together.',
    },
    {
      icon: 'intelligent' as IconName,
      color: PURPLE,
      t: 'Intelligent Business',
      d: 'Leverage real-time insights, automation and AI to make better decisions, faster.',
    },
    {
      icon: 'future' as IconName,
      color: TEAL,
      t: 'Future Ready',
      d: 'Build for agility, innovation and continuous transformation.',
    },
  ];
  const APPROACH = [
    {
      ...
      t: 'Understand',
      d: 'Understand your business, operating model, existing SAP landscape and transformation objectives.',
    },
    {
    ...
    },
    {
      ...
      t: 'Transform',
      d: 'Modernise applications and processes around the right SAP S/4HANA architecture.',
    },
    {
      icon: 'adopt' as IconName,
      t: 'Adopt',
      d: 'Enable people and the organisation to embrace new processes, technology and ways of working.',
    },
    {
      icon: 'evolve' as IconName,
      t: 'Evolve',
      d: 'Continuously improve as business needs and technology change.',
    },
  ];
  const PATHS = [
    {
      ...
      d: 'Build a modern SAP S/4HANA foundation around standardised processes and clean-core principles.',
    },
    {
      icon: 'conversion' as IconName,
      color: ORANGE,
      t: 'System Conversion',
      d: 'Modernise an existing SAP ERP landscape while preserving the capabilities that continue to create business value.',
    },
    {
      icon: 'selective' as IconName,
      color: PURPLE,
      t: 'Selective Transformation',
      d: 'Balance standardisation, continuity and business differentiation through a targeted transformation approach.',
    },
  ];
  const WHY = [
    {
      icon: 'biztech' as IconName,
      color: BLUE,
      t: 'Business + Technology',
      d: 'Connect SAP decisions with the business outcomes they are expected to create.',
    },
    {
      icon: 'standard' as IconName,
      color: ORANGE,
      t: 'Fit-to-Standard',
      d: 'Use proven processes while challenging unnecessary customisation.',
    },
    {
      icon: 'cleancore' as IconName,
      color: PURPLE,
      t: 'Clean Core',
      d: 'Create a foundation designed for long-term adaptability.',
    },
    {
      icon: 'link' as IconName,
      color: TEAL,
      t: 'Connected Thinking',
      d: 'Consider SAP S/4HANA as part of the wider enterprise ecosystem.',
    },
    {
      icon: 'loop' as IconName,
      color: BLUE,
      t: 'Continuous Transformation',
      d: 'Treat go-live as the beginning of the journey—not the end.',
    },
  ];
  ...
  return (
    <>
      ...
      <section style={{ position: 'relative', background: '#030D22', overflow: 'hidden' }}>
        ...
        >
          ...
          >
            ...
            <span style={{ color: '#fff', fontWeight: 700 }}>SAP S/4HANA</span>
          </nav>
          <p
            style={{
          ...
          >
            Transform the systems and processes that run your business with SAP S/4HANA—creating a
            simpler, intelligent and future-ready enterprise foundation.
          </p>
          ...
          <Reveal>
            <p
              style={{
                ...
                letterSpacing: 'var(--tracking-eyebrow)',
                textTransform: 'uppercase',
                color: 'var(--content-accent, #715300)',
                margin: '0 0 1.25rem',
              }}
            >
              The SAP S/4HANA Agenda
            </p>
            <h2
              style={{
                fontFamily: 'var(--family-display)',
            ...
            >
              Cloud ERP transformation is more than moving technology to the cloud. It requires a
              different approach to processes, architecture, data, governance and organisational
              change.
            </p>
            <p style={{ fontSize: '0.9375rem', lineHeight: 1.8, color: t.body, margin: 0 }}>
              TRYVION helps organisations move toward a modern SAP foundation built around
              standardisation, clean-core principles and continuous innovation.
            </p>
          </Reveal>
          <Reveal delay={120}>
            <div
            ...
            >
              {AGENDA.map((f, i) => (
                <button
                  ...
                  className="act-card"
                  style={{
                    ['--acc' as string]: f.color,
                    ['--tint' as string]: `${f.color}12`,
                    display: 'flex',
                    gap: '1.25rem',
                    width: '100%',
                    textAlign: 'left',
                    ...
                    background: 'none',
                    border: 'none',
                    borderBottom: i < AGENDA.length - 1 ? `1px solid ${t.divider}` : 'none',
                    borderRadius: 'var(--radius-sm)',
                  }}
                >
                  ...
                  <span>
                    ...
                    <p style={{ fontSize: '0.9rem', lineHeight: 1.65, color: t.body, margin: 0 }}>
                      {f.d}
                    </p>
                  </span>
                </button>
          ...
          >
            ...
            >
              <line
                ...
                x2="100"
                y2="1"
                stroke={isDark ? 'rgba(255,255,255,0.25)' : 'rgba(11,30,61,0.2)'}
                strokeWidth="2"
                pathLength={100}
              />
            </svg>
      ...
      >
        <div style={{ maxWidth: 'var(--layout-content-wide)', margin: '0 auto' }}>
          <Reveal>
            ...
            >
              Two cloud editions. One transformation objective.
            </p>
            <h2
              style={{
                fontFamily: 'var(--family-display)',
      ...
      <section
        ...
        style={{
          background: t.bg1,
          padding: '0 clamp(1.25rem,5vw,3.5rem) clamp(4.5rem,8vw,7.5rem)',
        }}
      >
        <div style={{ maxWidth: 'var(--layout-content-wide)', margin: '0 auto' }}>
          <Reveal>
            ...
            {PATHS.map((p, i) => (
              <Reveal key={p.t} delay={i * 100}>
                <button
                  ...
                  style={{
                    ['--acc' as string]: p.color,
                    ['--tint' as string]: `${p.color}10`,
                    background: t.cardBg,
                    border: `1px solid ${t.border}`,
                    borderRadius: 'var(--radius-md)',
                    padding: '2rem',
          ...
          >
            {WHY.map((w, i) => (
              ...
              >
                ...
                <p style={{ fontSize: '0.8125rem', lineHeight: 1.65, color: t.body, margin: 0 }}>
                  {w.d}
                </p>
              </Reveal>
            ))}
            ...
            >
              ...
              >
                <div style={{ maxWidth: '34ch' }}>
                  ...
                  >
                    Let&apos;s turn your application landscape into a foundation for what&apos;s
                    next.
                  </h2>
                </div>
                <div
