...
const IC = {
  ...
  building:
    'M3.75 21h16.5M4.5 21V5.25A2.25 2.25 0 0 1 6.75 3h3A2.25 2.25 0 0 1 12 5.25V21m0-9h5.25a2.25 2.25 0 0 1 2.25 2.25V21M7.5 7.5h1.5m-1.5 3h1.5m-1.5 3h1.5',
  cube: 'm21 7.5-9-4.5-9 4.5m18 0v9l-9 4.5m9-9-9 4.5m-9-4.5v9l9 4.5m0-9L3 7.5',
  route:
    'M6 19a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm12-14a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM8 17h6a3 3 0 0 0 0-6H9a3 3 0 0 1 0-6h7',
  swap: 'M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5',
  extend:
    'M10 4.5a1.8 1.8 0 1 1 3.6 0H17a1.5 1.5 0 0 1 1.5 1.5v3.4a1.8 1.8 0 1 0 0 3.6V16a1.5 1.5 0 0 1-1.5 1.5h-3.4a1.8 1.8 0 1 1-3.6 0H6A1.5 1.5 0 0 1 4.5 16v-3.4a1.8 1.8 0 1 1 0-3.6V6A1.5 1.5 0 0 1 6 4.5h4',
  usercheck:
    'M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M16 3.13a4 4 0 0 1 0 7.75M9 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0Zm13 8.5-4 4-2-2',
  shield:
  ...
  truck:
    'M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2m11-1h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62l-3.48-4.35A1 1 0 0 0 16.72 8H14m-5 10H9',
  factory:
    'M2.25 21h19.5M3.75 21V6.75L9 10V6.75L14.25 10V4.5h6v16.5M7.5 14h.01M11.25 14h.01M15 14h.01',
  ...
  users:
    'M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM18.75 18.75c-.6-3.2-3.4-5.25-6.75-5.25s-6.15 2.05-6.75 5.25',
  refresh:
    'M16.023 9.348h4.992M2.985 19.644v-4.992m0 0h4.992m-4.993 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99',
...
export default function S4HanaPrivateEditionPage() {
  ...
  const step = (n: string, icon: string, title: string, d: string) => (
    <div
      style={{ display: 'flex', gap: '0.875rem', alignItems: 'flex-start', padding: '0.625rem 0' }}
    >
      <span
        style={{
      ...
      <div>
        <h3 style={{ fontSize: '0.9375rem', fontWeight: 700, color: P.ink, margin: '0 0 0.25rem' }}>
          {title}
        </h3>
        <p style={{ fontSize: '0.8438rem', lineHeight: 1.65, color: P.body, margin: 0 }}>{d}</p>
      </div>
      ...
      case 0:
        return (
          <>
            ...
            <h2 style={docH}>
              Enterprise depth. Cloud flexibility.
              <br />
              Built for what&apos;s next.
            </h2>
            <p style={docP}>Complex enterprises need more than a standard ERP deployment.</p>
            <p style={docP}>
              SAP S/4HANA Cloud, Private Edition provides the functional depth, configuration
              flexibility and extensibility required to support complex business environments—while
              bringing the advantages of a modern cloud operating model.
            </p>
            <p style={{ ...docP, margin: 0 }}>
              We help organisations use that flexibility deliberately, creating a modern enterprise
              core without carrying unnecessary complexity into the future.
            </p>
          </>
        );
      case 1:
          ...
          <>
            ...
            >
              {item(
                ...
                'Support sophisticated process requirements across finance, supply chain, manufacturing, procurement and other enterprise functions.',
              )}
              {item(
                IC.building,
                ORANGE,
                'Industry Depth',
                'Support industry-specific requirements where standardisation alone cannot address the complexity of the business.',
              )}
              {item(
                IC.sliders,
                PURPLE,
                'Configuration Flexibility',
                'Adapt the SAP environment to legitimate business requirements without compromising the broader transformation architecture.',
              )}
              {item(
                IC.extend,
                TEAL,
                'Extensibility',
                'Extend the platform where differentiation creates business value while applying clean-core principles.',
              )}
              {item(
                IC.cloud,
                BLUE,
                'Cloud Operations',
                'Move toward a modern cloud operating model while retaining the enterprise capabilities and flexibility your organisation requires.',
              )}
            </div>
          </>
        );
          ...
          <>
            ...
            >
              {item(
                ...
                BLUE,
                'Finance',
                'Create an integrated foundation for financial management, reporting and enterprise visibility.',
              )}
              {item(
                IC.truck,
                ORANGE,
                'Supply Chain',
                'Connect planning, procurement, logistics and operational execution across complex environments.',
              )}
              {item(
                IC.factory,
                PURPLE,
                'Manufacturing',
                'Support sophisticated manufacturing processes while creating opportunities for standardisation and optimisation.',
              )}
              {item(
                IC.cart,
                TEAL,
                'Procurement',
                'Integrate sourcing, purchasing and supplier processes into the wider enterprise operating model.',
              )}
              {item(
                IC.cog,
                BLUE,
                'Asset & Operations',
                'Connect asset-intensive and operational processes with the enterprise core.',
              )}
              {item(
                IC.layers,
                ORANGE,
                'Industry-Specific Processes',
                'Support differentiated processes where industry requirements demand greater depth and flexibility.',
              )}
            </div>
          </>
        );
        ...
        return (
          <>
            ...
            {step(
              ...
              IC.search,
              'Discover',
              'Understand the business model, existing SAP landscape, processes, integrations and transformation objectives.',
            )}
            {step(
              '02',
              IC.gauge,
              'Assess',
              'Identify technical debt, customisations, process variations and opportunities for simplification.',
            )}
            {step(
              '03',
              IC.eye,
              'Envision',
              'Define the future-state architecture and determine what should be standardised, retained, redesigned or extended.',
            )}
            {step(
              '04',
              IC.bolt,
              'Transform',
              'Modernise the SAP environment through the appropriate implementation, conversion or selective transformation path.',
            )}
            {step(
              '05',
              IC.users,
              'Adopt',
              'Enable people, processes and the organisation to operate effectively within the new environment.',
            )}
            {step(
              '06',
              IC.refresh,
              'Evolve',
              'Continuously optimise the landscape while adopting new capabilities and maintaining a clean, adaptable core.',
            )}
          </>
        );
      case 4:
          ...
          <>
            ...
            >
              {item(
                ...
                BLUE,
                'New Implementation',
                'Build a modern SAP S/4HANA foundation around redesigned processes, enterprise requirements and clean-core principles.',
              )}
              {item(
                IC.refresh,
                ORANGE,
                'System Conversion',
                'Modernise an existing SAP ERP environment while preserving the business capabilities that remain relevant.',
              )}
              {item(
                IC.swap,
                PURPLE,
                'Selective Transformation',
                'Transform selectively where the organisation needs to balance continuity, standardisation and business differentiation.',
              )}
              {item(
                IC.map,
                TEAL,
                'Landscape Transformation',
                'Rationalise complex SAP landscapes and create a more consistent enterprise architecture across business units and geographies.',
              )}
            </div>
          </>
        );
      case 5:
        return (
          <>
            ...
            <p style={docP}>
              TRYVION evaluates where SAP standard functionality provides the right answer, where
              configuration is justified and where extensions are required to support genuine
              differentiation.
            </p>
            <p style={{ ...docP, margin: 0 }}>
              We apply clean-core principles throughout the transformation—helping organisations
              retain the flexibility they need while creating a foundation that remains maintainable
      ...
      case 6:
        return (
          <>
            ...
            <h2 style={docH}>
              Designed for enterprises where complexity and differentiation matter.
            </h2>
            <p style={docP}>
              SAP S/4HANA Cloud, Private Edition can be particularly well suited to:
            </p>
            {item(
              IC.building,
              BLUE,
              'Large enterprises',
              'Managing complex processes, multiple business units and diverse operating environments.',
            )}
            {item(
              IC.refresh,
              ORANGE,
              'Established SAP environments',
              'Modernising existing SAP ERP or SAP ECC landscapes.',
            )}
            {item(
              IC.shield,
              PURPLE,
              'Regulated organisations',
              'Operating with specialised processes, governance requirements and complex controls.',
            )}
            {item(
              IC.factory,
              TEAL,
              'Industry-intensive businesses',
              'Requiring deep industry capabilities and sophisticated process support.',
            )}
            {item(
              IC.swap,
              BLUE,
              'Organisations with differentiated processes',
              'Where standardisation alone cannot support the business model.',
            )}
          </>
        );
      case 7:
          ...
          <>
            ...
            >
              {item(
                ...
                BLUE,
                'Business + Technology',
                'Connect transformation decisions with the business outcomes they are expected to create.',
              )}
              {item(
                IC.simplify,
                ORANGE,
                'Complexity Reduction',
                'Challenge legacy complexity before carrying it into the new environment.',
              )}
              {item(
                IC.cube,
                PURPLE,
                'Clean Core',
                'Protect the long-term maintainability, adaptability and upgradeability of the SAP foundation.',
              )}
              {item(
                IC.layers,
                TEAL,
                'Transformation Depth',
                'Address processes, data, integrations, architecture and organisational change as one transformation.',
              )}
              {item(
                IC.refresh,
                BLUE,
                'Continuous Evolution',
                'Create an environment capable of adapting as the enterprise and technology landscape change.',
              )}
            </div>
          </>
        );
      default:
        return (
          <>
            ...
            <h2 style={docH}>
              Modernise what holds you back.
              <br />
              Preserve what moves you forward.
            </h2>
            <div
              style={{
                display: 'grid',
            ...
            >
              {[
                'Simplify the enterprise landscape.',
                'Modernise legacy ERP.',
                'Preserve genuine business differentiation.',
                'Connect the enterprise.',
                'Reduce technical complexity.',
                'Create a stronger digital core.',
            ...
            <p style={{ ...docP, marginTop: '1.25rem', marginBottom: 0 }}>
              TRYVION helps organisations turn SAP S/4HANA Cloud, Private Edition into a modern
              enterprise foundation—without losing the capabilities that make the business unique.
            </p>
          </>
        );
    }
  ...
  return (
    <>
        ...
        >
          <Reveal>
            ...
            >
              ...
              <span style={{ color: '#fff', fontWeight: 700 }}>Cloud, Private Edition</span>
            </nav>
            <p
              style={{
            ...
            >
              Enterprise ERP. Cloud without compromise.
            </p>
            <h1
              style={{
                fontFamily: 'var(--family-display)',
            ...
            >
              Transform complex enterprise environments with a modern SAP S/4HANA foundation
              designed for greater flexibility, control and continuous innovation.
            </p>
            <p
              style={{
                fontSize: '0.9375rem',
            ...
            >
              TRYVION helps organisations move to SAP S/4HANA Cloud, Private Edition while
              modernising processes, simplifying the technology landscape and preserving the
              capabilities that create genuine business value.
            </p>
            ...
            <div className="pe-folder">
              <div className="pe-body">
                <div
                  className="pe-tabs"
                  role="tablist"
                  aria-label="SAP S/4HANA Cloud, Private Edition chapters"
                >
                  {CHAPTERS.map((c, i) => (
                    <button
                      key={c.num}
                    ...
                    >
                      <span className="pe-tab-left">
                        ...
                        <span className="i">
                          <Icon d={c.icon} color="currentColor" size={20} />
                        </span>
                      </span>
                ...
                <div className="pe-docwrap">
                  ...
                  <div
                    ...
                    id="pe-doc"
                    role="tabpanel"
                    aria-labelledby={`pe-tab-${CHAPTERS[active].num}`}
                  >
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                    ...
                    <div key={active} style={{ animation: 'docIn .5s cubic-bezier(.2,.7,.2,1)' }}>
                      {chapterBody()}
                    </div>
                  </div>
                </div>
      ...
      {/* ═══ FINAL CTA ═══ */}
      <section
        style={{ padding: '0 clamp(1.25rem,5vw,3.5rem) clamp(4.5rem,8vw,7rem)', background: t.bg2 }}
      >
        <div style={{ maxWidth: 'var(--layout-content-wide)', margin: '0 auto' }}>
          <Reveal>
            <div
            ...
            >
              ...
              >
                <div style={{ maxWidth: '40ch' }}>
                  ...
                  >
                    Modernise your enterprise core with the flexibility to support today&apos;s
                    complexity and the foundation to evolve for tomorrow.
                  </h2>
                </div>
                <div
                  style={{
