...
const IMG_IND_3 = '/images/supply-chain.jpeg';
const IMG_IND_4 =
...
const ICON_PATHS: Record<string, ReactNode> = {
  ...
  headset: (
    <>
      ...
      <path d="M21 14a2 2 0 0 1-2 2h-1v-5h1a2 2 0 0 1 2 2zM3 14a2 2 0 0 0 2 2h1v-5H5a2 2 0 0 0-2 2z" />
  ...
  network: (
    <>
      ...
      <path d="M12 8v3M12 11l-5 5M12 11l5 5" />
    </>
  ),
  finance: (
    <>
  ...
  cart: (
    <>
      ...
      <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.58h9.72a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12" />
    </>
  ),
  truck: (
    <>
  ...
  shield: (
    <>
      <path d="M12 22s8-4 8-10V5l-8-3-8 3v10c0 6 8 10 8 10z" />
    </>
  ),
  lock: (
    <>
  ...
  lightbulb: (
    <>
      <path d="M9 18h6M10 22h4M12 2a7 7 0 0 0-7 7c0 2 1 3.9 2.5 5.5C6.5 13.5 7 15 7 16h10c0-1 .5-2.5 1.5-3.5C16 10.9 17 9 17 7a7 7 0 0 0-7-7z" />
    </>
  ),
  target: (
    <>
...
export default function ArtificialIntelligencePage() {
  ...
  const btnOutline: CSSProperties = {
    ...
    padding: '0 1.5rem',
    borderRadius: '4px',
    border: `1px solid ${isDark ? 'rgba(255,255,255,0.3)' : t.border}`,
    color: t.heading,
    fontSize: '0.875rem',
    fontWeight: 600,
    textDecoration: 'none',
  ...
  return (
    <>
      ...
      <section
        style={{
          position: 'relative',
          background: 'linear-gradient(135deg, #050E2B 0%, #0A1B4D 100%)',
          overflow: 'hidden',
        ...
        >
          <Reveal>
            ...
            >
              FROM INTELLIGENCE
              <br />
              TO <span style={{ color: BLUE }}>ACTION.</span>
            </h1>
            <p
              style={{
                fontSize: '1.125rem',
            ...
            >
              AI creates value when intelligence moves into the processes, decisions and experiences
      ...
      <section id="agenda" style={{ background: t.bg2, padding: '5rem 0' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 1.5rem' }}>
          <Reveal style={{ textAlign: 'center', marginBottom: '4rem' }}>
            ...
            >
              From AI Ambition to Intelligent Enterprise Action.
            </h2>
          </Reveal>
      ...
      <section
        style={{
          background: 'linear-gradient(180deg, #050E2B 0%, #0A1B4D 100%)',
          padding: '5rem 1.5rem',
          position: 'relative',
          overflow: 'hidden',
        }}
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          >
            <Reveal>
              ...
              <div style={{ width: '60px', height: '4px', background: BLUE, marginTop: '1rem' }} />{' '}
              <br />
              <p style={{ fontSize: '1rem', fontWeight: 600, color: '#fff', marginBottom: '1rem' }}>
                Connect the Elements that Make AI Matter.
              </p>
            </Reveal>
                ...
                items={[
                  {
                    ...
                    desc: 'Trusted information and business context.',
                    img: IMG_NET_1,
                  },
                  {
                    title: 'BUSINESS PROCESSES',
                    desc: 'The workflows where decisions and actions occur.',
                    img: IMG_NET_2,
                  },
                  {
                    title: 'AI MODELS',
                    desc: 'The intelligence to understand, generate, predict and reason.',
                    img: IMG_NET_3,
                  },
                  {
                    title: 'JOULE & AGENTS',
                    desc: 'AI assistants and agents that help people understand, decide and act.',
                    img: IMG_NET_4,
                  },
                  {
                    title: 'APPLICATIONS & AUTOMATION',
                    desc: 'The systems and workflows that turn intelligence into execution.',
                    img: IMG_NET_5,
                  },
                  {
                    title: 'HUMAN EXPERTISE',
                    desc: 'The judgement, governance and accountability that keep AI purposeful.',
                    img: IMG_NET_6,
                  },
                ]}
              />
            ...
            {[
              {
                ...
                desc: 'Rules execute predefined activities.',
              },
              { n: '02', icon: 'headset', title: 'COPILOT', desc: 'AI assists the user.' },
              {
                ...
                icon: 'chat',
                title: 'AI ASSISTANT',
                desc: 'AI understands context and supports work.',
              },
              {
                n: '04',
                icon: 'bot',
                title: 'AI AGENT',
                desc: 'AI reasons and performs selected actions.',
              },
              {
                n: '05',
                icon: 'network',
                title: 'AGENTIC ENTERPRISE',
                desc: 'Multiple agents collaborate across processes with human governance.',
              },
            ].map((item, i) => (
              <Reveal
                key={item.n}
          ...
          <Reveal delay={200}>
            <CinematicCarousel
              items={[
                {
                  title: 'FINANCE',
                  desc: 'Intelligent insights, forecasting and exception management.',
                  img: IMG_IND_1,
                },
                {
                  title: 'PROCUREMENT',
                  desc: 'Supplier intelligence, spend analysis and process automation.',
                  img: IMG_IND_2,
                },
                {
                  title: 'SUPPLY CHAIN',
                  desc: 'Demand intelligence, planning and exception identification.',
                  img: IMG_IND_3,
                },
                {
                  title: 'HIRE-TO-RETIRE',
                  desc: 'Talent intelligence, skills insights and employee experiences.',
                  img: IMG_IND_4,
                },
                {
                  title: 'LEAD-TO-CASH',
                  desc: 'Sales intelligence, customer insights and revenue intelligence.',
                  img: IMG_IND_5,
                },
                {
                  title: 'IT & OPERATIONS',
                  desc: 'Process automation, knowledge assistance and application management.',
                  img: IMG_IND_6,
                },
              ]}
            />
              ...
              {[
                {
                  icon: 'shield',
                  title: 'GOVERNANCE',
                  desc: 'Clear accountability and AI governance.',
                },
                {
                  icon: 'lock',
                  title: 'SECURITY',
                  desc: 'Enterprise security and access controls.',
                },
                {
                  icon: 'eye',
                  title: 'PRIVACY',
                  desc: 'Data protection and responsible data use.',
                },
                {
                  icon: 'eye',
                  title: 'TRANSPARENCY',
                  desc: 'Explainability and visibility into AI behaviour.',
                },
                {
                  icon: 'users',
                  title: 'HUMAN OVERSIGHT',
                  desc: 'People remain accountable for critical decisions.',
                },
                {
                  icon: 'activity',
                  title: 'MONITORING',
                  desc: 'Ongoing validation, risk management and AI performance monitoring.',
                },
              ].map((item, i) => (
      ...
      <section style={{ background: t.bg1, padding: '5rem 1.5rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <Reveal style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            >
              BUSINESS-FIRST. AI-POWERED. BUILT TO SCALE.
            </h2>
          </Reveal>
            ...
            {[
              {
                ...
                icon: 'search',
                title: 'DISCOVER',
                desc: 'Understand business priorities, challenges, data, technology and AI ambition.',
              },
              {
                n: '02',
                icon: 'clipboard',
                title: 'ASSESS',
                desc: 'Evaluate AI readiness across business, data, technology, people and governance.',
              },
              {
                n: '03',
                icon: 'lightbulb',
                title: 'ENVISION',
                desc: 'Identify where GenAI, Agentic AI and intelligent automation can reinvent work.',
              },
              {
                n: '04',
                icon: 'target',
                title: 'PRIORITIZE',
                desc: 'Build an AI Value Portfolio focused on value, feasibility and risk.',
              },
              {
                n: '05',
                icon: 'pen',
                title: 'DESIGN',
                desc: 'Define architecture, data foundations, governance and operating model.',
              },
              {
                n: '06',
                icon: 'rocket',
                title: 'EXECUTE & SCALE',
                desc: 'Build, measure, industrialise and expand successful AI capabilities.',
              },
            ].map((item, i) => (
      ...
      >
        ...
        >
          <Reveal style={{ flex: '1 1 400px' }}>
            ...
            <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.8)', maxWidth: '500px' }}>
              Build an AI capability that connects strategy, technology, data, automation and
              people—and is designed to evolve with your organisation.
            </p>
          </Reveal>
