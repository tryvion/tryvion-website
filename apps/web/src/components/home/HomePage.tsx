...
const HERO_SLIDES = [
  {
    ...
    title: (
      <>
        The Future Is <br /> A Choice.
      </>
    ),
    href: '/about',
    img: heroIdeology.src,
  },
  {
    bar: 'Tryvion AI',
    tag: 'AI',
  ...
  {
    bar: 'Tryvion Applications',
    tag: 'Applications',
    title: 'Modernise the Enterprise Core.',
    href: '/services/applications',
    img: heroApplications.src,
  },
  {
    bar: 'Tryvion Talent',
    tag: 'Talent',
  ...
  return (
    <>
      ...
      >
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  'linear-gradient(90deg, rgba(3,13,34,0.72) 0%, rgba(3,13,34,0.38) 55%, rgba(3,13,34,0.12) 100%)',
              }}
            />
            <div
              style={{
                position: 'absolute',
                inset: 0,
                background: 'linear-gradient(to top, rgba(3,13,34,0.88) 0%, transparent 32%)',
              }}
            />
          </div>
        ))}
        ...
        <div
          style={{
            ...
            bottom: 0,
            zIndex: 3,
            background: 'linear-gradient(to top, rgba(3,13,34,0.92), rgba(3,13,34,0.35))',
          }}
        >
          <div
            style={{
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      fontWeight: i === heroIdx ? 700 : 500,
                      color: i === heroIdx ? '#fff' : 'rgba(255,255,255,0.45)',
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLElement).style.background = 'rgba(201,162,75,0.12)';
                }}
                onMouseLeave={(e) => {
      ...
      <section
        ...
        style={{
          background: t.bg1,
          padding: 'clamp(4.5rem,7vw,7rem) clamp(1.5rem,5vw,3.5rem)',
          scrollMarginTop: '80px',
        }}
      >
        <div style={{ maxWidth: '72rem', margin: '0 auto', textAlign: 'center' }}>
          <h2 style={sectionTitle}>
            Transformation begins with a <span style={{ color: t.gold }}>choice</span>.
          </h2>
          <p style={sectionSub}>
            Every organisation reaches moments where the path forward matters.
          </p>
          <div
            style={{
              display: 'flex',
          ...
          >
            {[
              {
                title: 'CHOICE',
                desc: 'Choose what comes next.',
                icon: (
                  <path
                    d="M12 3v18M12 7h6.5a1.5 1.5 0 0 1 0 3H12m0-3H5.5a1.5 1.5 0 0 0 0 3H12m0 4h6.5a1.5 1.5 0 0 1 0 3H12m0-3H5.5a1.5 1.5 0 0 0 0 3H12"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                ),
              ...
              {
                title: 'VISION',
                desc: 'See possibilities beyond today.',
                icon: (
                  <>
                    <path
              ...
              {
                title: 'MOMENTUM',
                desc: 'Turn decisions into progress.',
                icon: (
                  <>
                    <path d="M4 20V10M10 20V4M16 20v-8M21 20H3" strokeLinecap="round" />
                    <path d="M10 4l6 8" strokeLinecap="round" />
                  </>
                ),
              },
              {
                title: 'FUTURE',
                desc: 'Create what comes next.',
                icon: (
                  <path
              ...
              <div
                key={s.title}
                style={{ display: 'flex', alignItems: 'center', gap: 'clamp(0.75rem,5vw,4.75rem)' }}
              >
                <div style={{ width: '125px' }}>
                  ...
                  <div style={{ fontSize: '0.90rem', color: t.muted, lineHeight: 1.5 }}>
                    {s.desc}
                  </div>
                </div>
                {i < arr.length - 1 && (
                  <span style={{ color: t.ink, marginTop: '-2.5rem', flexShrink: 0 }}>
      ...
      <section
        style={{
          background: t.bg2,
          padding: 'clamp(4rem,6vw,6rem) clamp(1.5rem,5vw,3.5rem)',
        ...
        >
          <div>
            ...
            >
              ...
              We engineer{' '}
              <span
                style={{ color: t.gold, borderBottom: `3px solid ${t.gold}`, paddingBottom: '2px' }}
              >
                momentum
              </span>
              .
      ...
      >
        <div style={{ maxWidth: '82rem', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <p style={sectionSub}>
              An integrated portfolio to choose stronger, move faster and grow with confidence.
            </p>
          </div>
            ...
            {[
              ...
              },
              {
                ...
                icon: (
                  <>
                    <path
                      d="M12 4.5v-2M12 21.5v-2M4.5 12h-2M21.5 12h-2M6 6l-1.4-1.4M19.4 19.4L18 18M18 6l1.4-1.4M6 18l-1.4 1.4"
                      strokeLinecap="round"
                    />
              ...
              {
                title: 'Data',
                desc: 'Turn data into decisions and new opportunities.',
                href: '#',
                cta: 'Explore Data',
                icon: (
                  <>
              ...
              {
                title: 'Cloud',
                desc: 'Build a secure, scalable and future-ready enterprise.',
                href: '#',
                cta: 'Explore Cloud',
                icon: (
                  <path
              ...
              {
                title: 'Talent',
                desc: 'Access and develop the skills to power transformation.',
                href: '/services/talent',
                cta: 'Explore Talent',
                icon: (
                  <>
                    <circle cx="9" cy="8" r="3.25" />
                    <path d="M3.5 19.5c.6-3.2 2.9-5 5.5-5s4.9 1.8 5.5 5" strokeLinecap="round" />
              ...
              {
                title: 'Academy',
                desc: 'Build future-ready capability for your organisation.',
                ...
                icon: (
                  <>
                    ...
                    <path
                      d="M6.5 11v4.5c0 1.4 2.5 2.75 5.5 2.75s5.5-1.35 5.5-2.75V11"
                      strokeLinecap="round"
                    />
                    <path d="M21.5 9v5" strokeLinecap="round" />
                  </>
                ),
              },
              {
                title: 'Operate',
                desc: 'Run, optimise and improve with confidence.',
                ...
                icon: (
                  <>
                    <circle cx="12" cy="12" r="3" />
                    <path
                      d="M12 2.8l1.5 2.6h3l1.5 2.6-1.5 2.6 1.5 2.6-1.5 2.6h-3L12 21.2l-1.5-2.6h-3L6 16l1.5-2.6L6 10.8 7.5 8.2h3L12 2.8z"
                      strokeLinejoin="round"
                    />
                  </>
                ),
              ...
              {
                title: 'Labs',
                desc: 'Accelerate innovation with reusable assets and IP.',
                href: '#',
                cta: 'Explore Labs',
                icon: (
                  <>
                    <path
                      d="M9.5 3h5M10.5 3v6L4.8 18.5A2 2 0 0 0 6.6 21.5h10.8a2 2 0 0 0 1.8-3L13.5 9V3"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: 'var(--elevation-01)',
                  transition:
                    'box-shadow var(--motion-duration-fast) var(--motion-easing-standard), border-color var(--motion-duration-fast) var(--motion-easing-standard)',
                }}
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLElement).style.boxShadow = 'var(--elevation-02)';
                  (e.currentTarget as HTMLElement).style.borderColor =
                    'var(--border-strong, rgba(11,30,61,0.2))';
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLElement).style.boxShadow = 'var(--elevation-01)';
              ...
              >
                ...
                >
                  <span style={{ color: t.heading, display: 'flex' }}>
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
      ...
      <section
        style={{
          ...
          background: '#030D22',
          overflow: 'hidden',
          padding: 'clamp(5rem,8vw,7.5rem) clamp(1.5rem,5vw,3.5rem)',
        }}
      >
        <img
          src={IMG.aiWave}
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(90deg, rgba(3,13,34,0.88) 0%, rgba(3,13,34,0.55) 45%, rgba(3,13,34,0.15) 100%)',
          }}
        />
        <div
          style={{
        ...
        >
          <div>
            ...
            >
              From assistance to
              <br />
              intelligent <span style={{ color: t.gold }}>execution</span>.
            </h2>
            <p
              style={{
                fontSize: '0.9375rem',
          ...
          <div className="evo-row" style={{ padding: '1rem 0.5rem 0' }}>
            ...
            {[
              {
                ...
                icon: (
                  <path
                    d="M12 3v18M12 7h6.5a1.5 1.5 0 0 1 0 3H12m0-3H5.5a1.5 1.5 0 0 0 0 3H12"
                    strokeLinecap="round"
                  />
                ),
              },
              {
                ...
                icon: (
                  <>
                    ...
                    <path
                      d="M5.5 19c.8-3.4 3.4-5.25 6.5-5.25S17.7 15.6 18.5 19"
                      strokeLinecap="round"
                    />
                  </>
                ),
              },
              {
                ...
                icon: (
                  <>
                    ...
                    <path d="M9.5 10.5h5M9.5 13.5h3" strokeLinecap="round" />
              ...
              },
              {
                ...
                icon: (
                  <>
                    ...
                    <path d="M12 8.5v3.5l2.5 2.5" strokeLinecap="round" strokeLinejoin="round" />
                  </>
                ),
              },
            ].map((s, i) => (
              <div
                ...
                style={{
                  ...
                  alignItems: 'center',
                  gap: '0.625rem',
                  marginBottom: `calc(var(--evo-step) * ${i})`,
                  position: 'relative',
                  zIndex: 1,
                }}
              >
            ...
            <div
              style={{
                ...
                alignItems: 'center',
                gap: '0.625rem',
                marginBottom: `calc(var(--evo-step) * 4)`,
                position: 'relative',
                zIndex: 1,
              }}
            >
              <span
                style={{
                  ...
                  boxShadow: '0 0 32px rgba(201,162,75,0.4)',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  color: t.gold,
      ...
      >
        <div style={{ maxWidth: '82rem', margin: '0 auto' }}>
          ...
          <div className="ind-grid">
            {[
              { label: 'Manufacturing', img: IMG.manufacturing, href: '/industries' },
              {
                label: 'Financial Services',
                img: IMG.financial,
                href: '/industries',
              },
              { label: 'Retail & Consumer', img: IMG.retail, href: '/industries' },
              { label: 'Healthcare', img: IMG.healthcare, href: '/industries' },
              { label: 'Public Sector', img: IMG.publicSector, href: '/industries' },
            ].map((ind) => (
              <Link
                key={ind.label}
                href={ind.href}
      ...
      >
        <div style={{ maxWidth: '72rem', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <p style={sectionSub}>
              Ideas, research and stories for leaders who choose what&apos;s next.
            </p>
          </div>
          <div className="per-grid">
            {[
              {
                cat: 'Insight',
                title: 'The Enterprise in the Age of AI Agents',
                img: IMG.cityNight,
                href: '#',
              },
              {
                cat: 'Research',
                title: 'Cloud-Driven Transformation Outlook 2026',
                img: IMG.wind,
                href: '#',
              },
              {
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: t.dimmer, flexShrink: 0 }}>
                    <Arrow size={16} />
                  </span>
                </div>
              </Link>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '1.75rem' }}>
            ...
            >
              View all insights <Arrow size={16} />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: t.ink }}>
        ...
        >
          <div style={{ minHeight: '320px', overflow: 'hidden' }}>
            <img
              src={IMG.careersTeam}
              alt="TRYVION team facing the sunrise through a glass office"
          ...
          >
            ...
            >
              Join a team of innovators, thinkers and doers shaping the future for organisations
              around the world.
            </p>
            <Link href="/careers" style={goldBtn}>
              Explore Careers <Arrow />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section
        style={{
          ...
          overflow: 'hidden',
          background: '#030D22',
          padding: 'clamp(5rem,9vw,8rem) clamp(1.5rem,5vw,3.5rem)',
        }}
      >
        <img
          src={IMG.earthBeam}
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(to bottom, rgba(3,13,34,0.75) 0%, rgba(3,13,34,0.35) 50%, rgba(3,13,34,0.7) 100%)',
          }}
        />
        <div
          style={{
